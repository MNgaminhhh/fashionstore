...
function renderProductCount(page: number, perPageProduct: number, totalProduct: number): string {
...
export { formatCurrency, getDateDifference, calculateDiscount, renderProductCount };
