...
export const categoryMenus: CategoryItem[] = [
    ...
    { icon: FaceRetouchingNaturalIcon, title: "Health & Beauty", href: "/products/search/health&beauty" },
    { icon: PetsIcon, title: "Pets", href: "/products/search/pets" },
    { icon: SportsEsportsIcon, title: "Baby Toys", href: "/products/search/baby-toys" },
    { icon: RestaurantIcon, title: "Groceries", href: "/products/search/groceries" },
    { icon: DirectionsCarIcon, title: "Automotive", href: "/products/search/automotive" },
];
