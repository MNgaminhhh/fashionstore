...
import { ContentWrapper, ImageWrapper, StyledCard } from "../productcard1/styles";
        ...
        >
            <ImageWrapper>
                <Link href={`/vendors/${id}`}>
                    <BaseImage priority src={banner} width={500} height={300} alt={storeName} />
                </Link>
            </ImageWrapper>
            ...
            <ContentWrapper sx={{ padding: 2 }}>
                <Box flex="1 1 0" minWidth="0px" mr={1}>
                    <Link href={`/vendors/${id}`}>
                        <Span fontSize="20px" fontWeight={600} color="primary.main" display="block">
                            {storeName}
                        </Span>
                    </Link>
